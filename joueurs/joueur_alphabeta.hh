...
public:
  ...
  static std::unique_ptr<std::vector<Brix>> rechercheCoupValide(JeuBinaire &jeuBinaire);
  coup_select alphabeta(JeuBinaire &jeuBinaire, int &alpha, int &beta, std::chrono::high_resolution_clock::time_point &start, unsigned int &profondeur_max, unsigned int profondeur, Brix &coupAJouer); // Algorithme alpha beta de base
