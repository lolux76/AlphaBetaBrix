...
int main()
{
    ...
    // std::cout << info.accNbPieceAlignJ()[0] << std::endl;
    // std::cout << info.accNbPieceAlignA()[0] << std::endl;

    // std::cout << "alignement diagonal : " << std::endl;
    // std::cout << info.accNbPieceAlignJ()[2] << std::endl;
    // std::cout << info.accNbPieceAlignA()[2] << std::endl;

    // std::cout << "Temps écoulé : " << ms_int.count() << "us" << std::endl;
